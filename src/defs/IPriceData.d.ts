...
const typeMap: any = {
    Welcome: o(
        [
            ...
            { json: "beta_value", js: "beta_value", typ: u(undefined, 3.14) },
            {
                json: "first_data_at",
                js: "first_data_at",
            ...
            { json: "quotes", js: "quotes", typ: u(undefined, r("Quotes")) },
        ],
        false
    ),
    Quotes: o([{ json: "USD", js: "USD", typ: u(undefined, r("Usd")) }], false),
    Usd: o(
        [
            { json: "price", js: "price", typ: u(undefined, 3.14) },
            { json: "volume_24h", js: "volume_24h", typ: u(undefined, 3.14) },
            {
                json: "volume_24h_change_24h",
                js: "volume_24h_change_24h",
            ...
            {
                json: "percent_change_15m",
                js: "percent_change_15m",
                typ: u(undefined, 3.14),
            },
            {
                json: "percent_change_30m",
                js: "percent_change_30m",
                typ: u(undefined, 3.14),
            },
            {
                json: "percent_change_1h",
                js: "percent_change_1h",
                typ: u(undefined, 3.14),
            },
            {
                json: "percent_change_6h",
                js: "percent_change_6h",
                typ: u(undefined, 3.14),
            },
            {
                json: "percent_change_12h",
                js: "percent_change_12h",
                typ: u(undefined, 3.14),
            },
            {
                json: "percent_change_24h",
                js: "percent_change_24h",
                typ: u(undefined, 3.14),
            },
            {
                json: "percent_change_7d",
                js: "percent_change_7d",
                typ: u(undefined, 3.14),
            },
            {
                json: "percent_change_30d",
                js: "percent_change_30d",
                typ: u(undefined, 3.14),
            },
            {
                json: "percent_change_1y",
                js: "percent_change_1y",
                typ: u(undefined, 3.14),
            },
            { json: "ath_price", js: "ath_price", typ: u(undefined, 3.14) },
